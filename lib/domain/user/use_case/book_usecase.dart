...
class UserUseCaseImpl implements UserUseCase{
  ...
  @override
  Future<NetworkResponse<UserData>> getUserByEmail({required String email}) async => await userRepository.getUserByEmail(email: email);

  @override
  Future<NetworkResponse<UserData>> registerUser({required UserBody requestBody}) async => await userRepository.registerUser(requestBody: requestBody);

  @override
  Future<NetworkResponse<UserData>> updateUser({required UserBody requestBody}) async => await userRepository.updateUser(requestBody: requestBody);
