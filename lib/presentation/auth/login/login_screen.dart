...
class LoginScreen extends GetView<LoginController>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text(Texts.textLogin, style: TextStyles.highlightText.copyWith(fontWeight: FontWeight.bold),), automaticallyImplyLeading: false,),
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Column(
              children: [
                SvgPicture.asset(ImageAssets.imgLoginBanner,),
                const Gap(),
                const Text(Texts.textSelamatDatang, style: TextStyles.highlightText,),
                const Gap(h: Dimens.d8,),
                const Text(Texts.textDescSelamatDatang, style: TextStyles.subTitle, textAlign: TextAlign.center,),
              ],
            ),
            Column(
              children: [
